...
class PulseWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        fun updateWidget(context: Context, manager: AppWidgetManager, widgetId: Int) {
            ...
            // Recommendation
            val targetName = telemetry.recommendation.account.username
            views.setTextViewText(R.id.widget_rec_pill, "Use $targetName")
            ...
            // Launch button text
            views.setTextViewText(R.id.widget_btn_launch, "Open Claude as $targetName")

            // 1-Tap Open App (on background tap)
